...
pub trait AnyConnectionBackend: std::any::Any {
    ...
    #[cfg(feature = "migrate")]
    fn as_migrate(&mut self) -> Option<&mut dyn crate::migrate::Migrate> {
        None
    }
    ...
    ) -> BoxFuture<'e, crate::Result<AnyStatement<'q>>>;

    fn describe<'q>(
        &'q mut self,
        sql: &'q str,
    ) -> BoxFuture<'q, crate::Result<Describe<Self::Database>>>;
}
